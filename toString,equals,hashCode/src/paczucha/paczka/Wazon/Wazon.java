...
//    }
    ...
    //sprawdzic ocb 5)
    public int hashCode() {
        int result = color != null ? color.hashCode() : 0;// jak dziala ten ? i : 3)
        // jezeli color != null to color.hashCode() a jak color == null to 0
        result = 31 * result + height;// sie robi 31*result+height, bo mnozenie razy 31 to liczba pierwsza cos tam cos tam
